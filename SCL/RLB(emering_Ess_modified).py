...
# -*- coding: utf-8 -*-
"""
Converted from Jupyter Notebook: RL_ESS_Frequency_modified.ipynb
Conversion Date: 2025-11-06T03:49:15.484Z
"""
...
data = loadmat('/content/drive/MyDrive/Colab Notebooks/SCL/data/IEEE-39-adjacency-matrix.mat')
D=data['D']
D=np.asarray(D)

data = loadmat('/content/drive/MyDrive/Colab Notebooks/SCL/data/IEEE-39-power-initial-balanced.mat')
Power_initial=data['power_initial']
Power_initial=np.asarray(Power_initial)

data = loadmat('/content/drive/MyDrive/Colab Notebooks/SCL/data/IEEE-39-rotational-inertial-generator.mat')
...
data = loadmat('/content/drive/MyDrive/Colab Notebooks/SCL/data/IEEE-39-rotational-inertial-load.mat')
Rotational_inertial_load=data['rotational_inertial_load']
Rotational_inertial_load=np.asarray(Rotational_inertial_load)

data = loadmat('/content/drive/MyDrive/Colab Notebooks/SCL/data/IEEE-39-susceptance-matrix.mat')
